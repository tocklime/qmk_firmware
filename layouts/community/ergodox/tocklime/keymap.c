...
,KC_LGUI           ,KC_LALT ,TRNS    ,TRNS    ,KC_BSPACE
		,KC_HOME,KC_END
		        ,KC_PGUP
	 ,KC_SPACE,TT(NUMP),KC_PGDOWN
//Right	 
    ,KC_MINUS,KC_6    ,KC_7     ,KC_8          ,KC_9   ,KC_0           ,KC_EQUAL
    ,KC_RBRC ,KC_Y    ,KC_U     ,KC_I          ,KC_O   ,KC_P           ,TRNS
...
[SYST] = LAYOUT_ergodox(TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,RGB_TOG,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,RGB_VAI,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,RESET,TRNS,TRNS,TRNS,TRNS,TRNS,RGB_VAD,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,KC_ASON,KC_ASRP,TRNS,TRNS,TRNS,TRNS,TRNS,KC_ASUP,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,KC_ASDN,TRNS,TRNS,TRNS,TRNS,TRNS,RESET,TRNS,TRNS,TRNS,TRNS,TRNS,TO(BASE),TRNS,TRNS,TRNS,TRNS,TRNS)
