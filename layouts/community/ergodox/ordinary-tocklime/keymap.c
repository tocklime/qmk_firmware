 ...
 * `------------+------+------+------+------+-------------'       `-------------+------+------+------+------+------------'
 *      | LGui | LCtrl | LAlt | Meh  | Spc  |                                   | RGui | RAlt | Hyper|  Meh | RCtrl |
 *      `-----------------------------------'                                   `-----------------------------------'
 *                                          ,-------------.       ,-------------.
 *                                          | Home | End  |       | Left | Right|
 *                                   ,------|------|------|       |------+------+------.
...
,KC_LGUI   ,KC_LCTL        ,KC_LALT, MEH_T(KC_NO),KC_SPC
                                 ...
                                 ,KC_BSPC,KC_DEL ,KC_PGDN
                                                                 ...
                                                                 ,KC_RBRC ,KC_Y ,KC_U           ,KC_I   ,KC_O   ,KC_P             ,F(RMdia)
                                                                          ,KC_H ,KC_J           ,KC_K   ,KC_L   ,LT(RBASE,KC_SCLN),F(RSymb)
...
,KC_QUOT     ,LT(RBASE, KC_SCLN)     ,KC_L   ,KC_K   ,KC_J  ,KC_H
...
,KC_RCTL   ,MEH_T(KC_NO),ALL_T(KC_NO),KC_RALT,KC_RGUI
                                    ...
                                    ,KC_SPC  ,KC_ENT  ,KC_DOWN
                                                                 ...
                                                                 ,LSFT(KC_TAB),KC_B   ,KC_V   ,KC_C   ,KC_X    ,KC_Z  ,KC_LSFT
                                                                                      ,KC_SPC,MEH_T(KC_NO),KC_LALT,KC_LCTL,KC_LGUI
                                                                 ,KC_HOME     ,KC_END
                                                                 ,KC_PGUP
